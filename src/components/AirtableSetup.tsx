...
export function AirtableSetup() {
  return (
    <Alert className="max-w-4xl mx-auto my-4 sm:my-8 mx-4">
      <AlertCircle className="h-4 w-4" />
      <AlertTitle className="text-sm sm:text-base">Setup Required: Connect Airtable</AlertTitle>
      <AlertDescription className="mt-2 space-y-2 sm:space-y-3 text-xs sm:text-sm">
        <p>To enable tribute submissions, follow these steps:</p>
        <ol className="list-decimal list-inside space-y-1 sm:space-y-2 mt-2">
          <li>
          ...
          <li>
            ...
            <a href="https://airtable.com/create/tokens" target="_blank" rel="noopener noreferrer" className="text-primary underline break-all">
          ...
          <li>
            <strong>Update the configuration</strong> in <code className="bg-muted px-1 py-0.5 rounded text-xs">src/services/airtable.ts</code> with your credentials
          </li>
        </ol>
